...
//App 2
       _app2Text = "Base Location";
       _app2Logo = "XM8Apps\Images\BaseMarker.paa";
       app2_action = {execVM "XM8Apps\Apps\BaseMarker\basemarker.sqf";};

//App 3
       _app3Text = "Player Light";
       _app3Logo = "XM8Apps\Images\lamp.paa";
       app3_action = {closeDialog 8457;execVM"XM8Apps\Apps\Player_Light\Player_Light.sqf";};

//App 4
	   _app4Text = "Recipes";
	   _app4Logo = "XM8Apps\images\BRAma.paa";
	   app4_action = {execVM "XM8Apps\Apps\Recipes\BRama.sqf";};

//App 5
_app5Text = "Selfie";
_app5Logo = "xm8Apps\Apps\selfie\selfie.paa";
app5_action = {closeDialog 8457;execVM "xm8Apps\Apps\selfie\selfie.sqf";};

//App 6
       _app6Text = "Keep this server alive: CLICK HERE";
       _app6Logo = "XM8Apps\images\donate.paa";
       app6_action = {execVM"XM8Apps\Apps\ServerRules\rules.sqf";};

//App 7
_app7Text = "Recuit Ai Soldier: x1 Beef Parts";
_app7Logo = "xm8Apps\Apps\eBase\images\EBase.paa";
app7_action = {execVM "xm8Apps\Apps\eBase\Scripts\ebase.sqf";};
