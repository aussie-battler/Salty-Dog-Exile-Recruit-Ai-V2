...
Modified to spawn Ai Soldiers by Aussie 27.06.18
v1.0 
*/
/////////////////////
//Config
...
orderIDcharacters = "SALTY DOG"; //Characters to be displayed at the start of each unique order number (can be a community name abbreviation ie: ESG (Evolved Survival Gaming)
_Box1Name = "Missile Specialist (AT)";
Box1Items = [
['arifle_Mk20C_ACO_pointer_F',1],
...
_Box2Name = "Missile Specialist (AA)";
Box2Items = [
['arifle_Mk20C_ACO_pointer_F',1],
['launch_I_Titan_F',1],
['hgun_ACPC2_F',1]
...
//set XM8 title
(_display displayCtrl 4004) ctrlSetStructuredText (parseText (format ["<t align='center' font='RobotoMedium'>Salty Dog Recruit Ai: x1 Beef Parts</t>"]));
...
_Box1Btn ctrlSetStructuredText (parseText (format ["%1<br/><img image='\exile_assets\texture\ui\poptab_notification_ca.paa' size='1.0' shadow='true' />Beef Parts",_Box1Name]));
...
_Box2Btn ctrlSetStructuredText (parseText (format ["%1<br/><img image='\exile_assets\texture\ui\poptab_notification_ca.paa' size='1.0' shadow='true' />Beef Parts",_Box2Name]));
...
_Box3Btn ctrlSetStructuredText (parseText (format ["%1<br/><img image='\exile_assets\texture\ui\poptab_notification_ca.paa' size='1.0' shadow='true' />Beef Parts",_Box3Name]));
...
_Box4Btn ctrlSetStructuredText (parseText (format ["%1<br/><img image='\exile_assets\texture\ui\poptab_notification_ca.paa' size='1.0' shadow='true' />Beef Parts",_Box4Name]));
...
_Box5Btn ctrlSetStructuredText (parseText (format ["%1<br/><img image='\exile_assets\texture\ui\poptab_notification_ca.paa' size='1.0' shadow='true' />Beef Parts",_Box5Name]));
...
_Box6Btn ctrlSetStructuredText (parseText (format ["%1<br/><img image='\exile_assets\texture\ui\poptab_notification_ca.paa' size='1.0' shadow='true' />Beef Parts",_Box6Name]));
    ...
    case (1): {
      {
        ...
        _itemDispName = getText (configfile >> "CfgWeapons" >> _item >> "displayName");
...
[] execVM "xm8Apps\Apps\eBase\Scripts\Guard\guard1.sqf";
};

fnc_buybox2 = {
(findDisplay 24015) closeDisplay 0;
[] execVM "xm8Apps\Apps\eBase\Scripts\Guard\guard2.sqf";
};

fnc_buybox3 = {
(findDisplay 24015) closeDisplay 0;
[] execVM "xm8Apps\Apps\eBase\Scripts\Guard\guard3.sqf";
};

fnc_buybox4 = {
(findDisplay 24015) closeDisplay 0;
[] execVM "xm8Apps\Apps\eBase\Scripts\Guard\guard4.sqf";
};

fnc_buybox5 = {
(findDisplay 24015) closeDisplay 0;
[] execVM "xm8Apps\Apps\eBase\Scripts\Guard\guard5.sqf";	
};

fnc_buybox6 = {
(findDisplay 24015) closeDisplay 0;
[] execVM "xm8Apps\Apps\eBase\Scripts\Guard\guard6.sqf";
};
...
fnc_goBack = {
  _display = uiNameSpace getVariable ["RscExileXM8", displayNull];
  _Ctrls = [1116,851,852,853,854,855,856,857,858,1230];
  {
